...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "pda";
        LicenseKey = "LKNW54LP1VBVV21BY21LC9E5KGHP8QVR";

        //Session["MaDonVi"] = "QuanTri";

        // The base URL used to reach files in CKFinder through the browser.
        BaseUrl = "/Content/Data/Temp/";
        if (Session["MaVaiTro"] != null && Session["MaVaiTro"].ToString() == "QuanTri") BaseUrl = "/Content/Data/";
        else if (Session["MaDonVi"] != null)
        {
            switch (Session["MaDonVi"])
            {
                case "SoNongNghiep":
                    BaseUrl = "/Content/Data/so-nong-nghiep/";
                    break;
                case "LinhVucThuySan":
                    BaseUrl = "/Content/Data/linh-vuc-thuy-san/";
                    break;
                case "LinhVucTrongTrotVaBVTV":
                    BaseUrl = "/Content/Data/linh-vuc-trong-trot-va-bao-ve-thuc-vat/";
                    break;
                case "LinhVucChanNuoiVaThuY":
                    BaseUrl = "/Content/Data/linh-vuc-chan-nuoi-va-thu-y/";
                    break;
                case "LinhVucKhuyenNong":
                    BaseUrl = "/Content/Data/linh-vuc-khuyen-nong/";
                    break;
                case "LinhVucGiongNongNghiep":
                    BaseUrl = "/Content/Data/linh-vuc-giong-nong-nghiep/";
                    break;
                case "UBNDTinh":
                    BaseUrl = "/Content/Data/ubnd-tinh/";
                    break;
                case "LinhVucLamNghiep":
                    BaseUrl = "/Content/Data/linh-vuc-lam-nghiep/";
                    break;
                case "LinhVucPhatTrienNongThon":
                    BaseUrl = "/Content/Data/linh-vuc-phat-trien-nong-thon/";
                    break;
                case "LinhVucThuyLoi":
                    BaseUrl = "/Content/Data/linh-vuc-thuy-loi/";
                    break;
                case "LinhVucQuanLyChatLuong":
                    BaseUrl = "/Content/Data/linh-vuc-quan-ly-chat-luong/";
                    break;
                case "BoNongNghiep":
                    BaseUrl = "/Content/Data/bo-nong-nghiep/";
                    break;
                default:
                    BaseUrl = "/Content/Data/so-nong-nghiep/";
                    break;
        ...
        ResourceType type;
        if (Session["MaVaiTro"] != null && Session["MaVaiTro"].ToString() == "QuanTri")
        {
            type = ResourceType.Add("Thu-muc-tap-tin");
            type.Url = BaseUrl;
            type.Dir = BaseDir == "" ? "" : BaseDir;
            type.MaxSize = 0;
            //Thêm các đuôi hình để tài khoản quản trị được xem hình trong file
            type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png", "7z", "aiff", "asf", "avi", "csv", "doc", "docx", "fla", "flv", "gz", "gzip", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
            type.DeniedExtensions = new string[] { };
        }
        else
        {
            type = ResourceType.Add("Thu-muc-hinh-anh");
            ...
            type.MaxSize = 0;
            type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "csv", "doc", "docx", "fla", "flv", "gz", "gzip", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
            type.DeniedExtensions = new string[] { };
        }
    }
