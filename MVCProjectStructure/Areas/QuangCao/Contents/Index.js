...
function XuLyDocDanhSachLoaiTheoNenTang(obj, IdLoai) {
    try {
        ...
        XuLyAPIOutputData('QuangCao/QuangCao/XuLyDocDanhSachLoai', input, IdLoai, iXuLyCapNhatLoai);
    } catch (e) {
...
function Them() {
    ThemCapNhat('QuangCao/QuangCao/ThongTinThemCapNhat', HamXuLy);
}
function ChinhSua(Id) {
    ThemCapNhat('QuangCao/QuangCao/ThongTinThemCapNhat', HamXuLy, Id);
}
...
function Luu(DongModal) {
    ...
    XuLyThongTinThemCapNhat('QuangCao/QuangCao/XuLyLuu', JsonInput, HamXuLy, 'QuangCao/QuangCao/XemDanhSach', DongModal);
}
function LuuDong() {
    Luu(true);
}
