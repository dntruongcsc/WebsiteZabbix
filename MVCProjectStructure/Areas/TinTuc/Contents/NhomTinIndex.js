function DuongDan1() {
    var duongDanGoc = $("#DuongDanNhom").val();
    if (!duongDanGoc || duongDanGoc === "") {
        var Ten = $("#Ten").val();
        if (Ten.length > 0) {
            var Duong = bodau(Ten);
            $("#DuongDanNhom").val(Duong);
        }
    }
}
function bodau(str) {
...
function XuLyTimKiem(trang) {
    try {
        ...
        XuLyCapNhatDanhSach('TinTuc/TinTuc/XemDanhSachNhomTin', thamSo);
    } catch (e) {
...
function Them() {
    ThemCapNhat('TinTuc/TinTuc/ThongTinThemCapNhatNhomTin', HamXuLy);
}
function ChinhSua(Id) {
    ThemCapNhat('TinTuc/TinTuc/ThongTinThemCapNhatNhomTin', HamXuLy, Id);
}
...
function Luu(DongModal) {
    ...
    XuLyThongTinThemCapNhat('TinTuc/TinTuc/XuLyLuuNhomTin', JsonInput, HamXuLy, 'TinTuc/TinTuc/XemDanhSachNhomTin', DongModal);
}
function LuuDong() {
    Luu(true);
}
...
function XoaDanhSach() {
    ...
    XuLyAPI('TinTuc/TinTuc/XuLyXoaDanhSachNhomTin', input, 'html', 'POST', iXuLyXoa);
}
