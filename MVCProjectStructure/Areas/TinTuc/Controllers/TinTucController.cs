...
namespace MVCProjectStructure.Areas.TinTuc.Controllers
{
    public class TinTucController : Controller
    {
        public ActionResult NhomTin()
        {
            ...
            TempData["returnUrl"] = Url.Action("Index", "NhomTin", new { Areas = "TinTuc" });
            try
            {
        ...
        private Models.NhomTinModel.NhomTinOutput.DocDanhSach DocDanhSachNhomTin(string tuKhoa = "", string idPhongBan = "", int? trangHienTai = 1)
        {
            ...
            var output = XuLyAPI.ApiJsonPost2(APIUrl.NhomTin.TimKiemPhanTrang, input, false) as CommonOutput;
        ...
        public ActionResult ThongTinThemCapNhatNhomTin(string Id)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(Id))
                {
                    ...
                    var output = XuLyAPI.ApiJsonPost2(APIUrl.NhomTin.DocThongTin, input, false) as CommonOutput;
                    if (output == null) throw new Exception(Message.LoiServer);
                    if (output.KetQua != 1) throw new Exception(output.ThongBao);
        ...
        public ActionResult XuLyLuuNhomTin(CommonNhomTin.NhomTinInput.ThongTinNhomTin input)
        {
            ...
            try
            {
                ...
                var url = !string.IsNullOrEmpty(input.Id) ? APIUrl.NhomTin.Sua : APIUrl.NhomTin.Them;
        ...
        public ActionResult XuLyXoaDanhSachNhomTin(List<string> danhSachId)
        {
            ...
            try
            {
                ...
                var output = XuLyAPI.ApiJsonPost2(APIUrl.NhomTin.XoaDanhSach, input) as CommonOutput;
                if (output == null) throw new Exception(Message.LoiServer);
                if (output.KetQua == 1)
                {
                    model.KetQua = 1;
        ...
        private Models.BaiVietModel.Output.DocDanhSach DocDanhSachBaiViet(string tuKhoa = "", string IdDonVi = "", string IdNhomTin = "", int? trangHienTai = 1)
        {
            try
            {
                ...
                var output = XuLyAPI.ApiJsonPost2(APIUrl.BaiViet.TimKiemPhanTrang, input) as CommonOutput;
                if (output == null) throw new Exception(Message.LoiServer);
                if (output.KetQua != 1) throw new Exception(output.ThongBao);
        ...
        public ActionResult ThongTinThemCapNhatBaiViet(string Id)
        {
            ...
            try
            {
                ...
                {
                    var input = new CommonInput.DocThongTinInput { Id = Id };
                    var output = XuLyAPI.ApiJsonPost2(APIUrl.BaiViet.DocThongTin, input) as CommonOutput;
                    if (output == null) throw new Exception(Message.LoiServer);
                    if (output.KetQua != 1) throw new Exception(output.ThongBao);
        ...
        public ActionResult XuLyLuuBaiViet(CommonBaiViet.Input.ThongTinBaiViet input)
        {
            ...
            try
            {
                ...
                input2.ThongBao = input.ThongBao;
                var url = !string.IsNullOrEmpty(input.Id) ? APIUrl.BaiViet.Sua : APIUrl.BaiViet.Them;
                ...
                if (output.KetQua == 1)
                {
                    if (input.ThongBao)
                    {
                        //var duLieuOutput = JsonConvert.DeserializeObject<BaiVietModel.Output.ThongTin>(output.DuLieu.ToString());
                        GuiThongBao(input, output);
                    }
        ...
        public ActionResult XuLyXoaDanhSachBaiViet(List<string> danhSachId)
        {
            ...
            try
            {
                var input = new CommonInput.XoaDanhSachInput2();
                input.Ids = danhSachId;
                var output = XuLyAPI.ApiJsonPost2(APIUrl.BaiViet.XoaDanhSach, input) as CommonOutput;
                if (output == null) throw new Exception(Message.LoiServer);
                if (output.KetQua == 1)
                {
                    model.KetQua = 1;
        ...
        public List<Models.NhomTinModel.NhomTinOutput.ThongTin> DocDanhSachNhomTin()
        {
            try
            {
                ...
                var output = new CommonOutput();
                output = XuLyAPI.ApiJsonPost2(APIUrl.NhomTin.DocDanhSach, input) as CommonOutput;
        ...
        public ActionResult DocDanhSachNhomTinTheoDonVi(string idPhongBan)
        {
            try
            {
                ...
                var output = new CommonOutput();
                output = XuLyAPI.ApiJsonPost2(APIUrl.NhomTin.DocDanhSachXuatBan, input) as CommonOutput;
